...
| CryptoPanic | News feed, feeds the rugpull "negative press" flag | Yes — free tier, you add it |
| Anthropic (Claude) | Optional: real natural-language answers in the AI chat dock | Optional, paid |

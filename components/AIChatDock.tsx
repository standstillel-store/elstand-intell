...
export function AIChatDock({ context }: { context: Record<string, unknown> }) {
  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    { role: "assistant", text: "Ask me about pump candidates, rugpull risk, whale flow, or sentiment right now." },
  ]);
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 sm:bottom-6 sm:right-6">
      {open ? (
        <div className="flex h-[28rem] w-[22rem] max-w-[90vw] flex-col rounded-xl border border-line bg-bg-raised shadow-2xl shadow-black/50">

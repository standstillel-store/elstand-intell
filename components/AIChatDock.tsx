...
export function AIChatDock({ context }: { context: Record<string, unknown> }) {
  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    {
      role: "assistant",
      text: 'Halo, saya ElVoid AI — asisten intelijen pasar Nocturn, berjalan dari data live. Coba tanya "analisa ALLO", "whale activity", "risk tertinggi", "momentum sekarang", atau "berita terbaru".',
    },
  ]);
